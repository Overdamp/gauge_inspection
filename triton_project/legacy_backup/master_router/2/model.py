        ...
        for request in requests:
            ...
            if task_type == "analog_gauge":
                ...
                results = {
                    ...
                    "confidence": 0.98,
                    "gauge_level": "Normal",
                    "message": "V2 Mock: Digital Gauge inference succeeded"
                }
                ...
                results = {
                    ...
                    "severity": "HIGH",
                    "confidence": 0.89,
                    "message": "V2 Mock: Abnormality detection succeeded"
                }
                ...
                results = {
                    ...
                    "confidence": 0.96,
                    "message": "V2 Mock: Water level measurement succeeded"
                }
                h, w = vis_img.shape[:2]
                ...
                results = {
                    "gas_detected": True,
                    "confidence": 0.92,
                    "message": "V2 Mock: Gas leakage detection succeeded"
                }
                ...
                results = {
                    ...
                    "smoke_detected": True,
                    "confidence": 0.87,
                    "message": "V2 Mock: Fire/smoke safety scanning succeeded"
                }
